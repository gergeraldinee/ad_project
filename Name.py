...
def submit():  # This is a callback function to Set whatever the User input
    username.set(entry1.get())
    print(entry1.get())
#    gender_label.setvar(usergender.get())
...
name_label = tk.Label(text="What's your name?", width=30,
                     height=2, foreground='black',
                     background='white')
name_label.pack()
entry1 = tk.Entry(width=20, text = "What's your name?")
entry1.pack()
